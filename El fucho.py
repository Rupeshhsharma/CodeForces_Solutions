...
For teams in the winners' that got paired up, each pair plays a football match in which there are no ties.If a team wins, it stays in the winners' group.
...
Let's consider the winners' group first. Note that exactly one team drops to the losers' bracket for every match in this group. Only one team is left in the winners' group right before the end, so n−1
matches must have been played in the winners' group right before the final match.

Similar logic applies to the losers' group. n−1 teams in total drop down to the losers' group over the course of the tournament. For every match played between two teams in this group, exactly one team is eliminated from the tournament. A single team in left in this group right before the final match, so n−2
matches must have been played in the losers' group right before the final match.
