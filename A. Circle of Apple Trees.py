...
At each tree, you may choose to either eat the apple or skip it. After making your choice, you move to the next tree: from tree i, you move to tree i+1 for 1≤i≤n−1, and from tree n
, you move back to tree 1. This process continues indefinitely as you move through the trees in a cycle.
However, you have a special condition: you may only eat an apple if its beauty is strictly greater than the beauty of the last apple you ate. For example, if b=[2,1,2,3] and you eat the apple on tree 1
(beauty 2), you cannot eat the apples on trees 2 and 3 because their beauties are not greater than 2. However, you may eat the apple on tree 4 since b4=3>2.
...
At tree 1, skip the apple.At tree 2, skip the apple.At tree 3, skip the apple.
At tree 4, eat the apple (beauty 1).
At tree 5, eat the apple (beauty 2).
At tree 1, skip the apple. You are not allowed to eat the apple as its beauty (b1=1) is not greater than the beauty of the last apple you ate (b5=2).
